...
package com.kv.kushapps.emojoy;
...
class Emojifier {
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        Log.v("number of faces = ", String.valueOf(faces.size()));
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Log.v("smilingProb =", String.valueOf(face.getIsSmilingProbability()));
        Log.v("leftEyeOpenProb =", String.valueOf(face.getIsLeftEyeOpenProbability()));
        Log.v("rightEyeOpenProb=", String.valueOf(face.getIsRightEyeOpenProbability()));
        ...
        Log.v("whichEmoji: ", String.valueOf(emoji.name()));
